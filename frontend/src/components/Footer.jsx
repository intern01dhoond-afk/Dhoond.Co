            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'inherit' }}>
              ...
              <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'inherit' }}>
                {[
                  ...
                  <a key={idx} href={s.url} target="_blank" rel="noopener noreferrer" aria-label={s.name} style={{ width: '40px', height: '40px', background: 'rgba(255,255,255,0.08)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s ease', textDecoration: 'none' }}
                    onMouseEnter={e => {
